...
public class GameBoard extends JComponent implements MouseListener {
	...
	private static int lastDelete = -1;
	...
	public static boolean isThreat(int x, int y, int side) {
		for (int selected = 0; selected < pieces.length; selected++) {
			if ((pieces[selected] != null) && (side != pieces[selected].getSide())
					&& (pieces[selected].isValid(x, y))) {
				return true;
			}
		}
	...
	public void mouseReleased(MouseEvent e) {
		try {
			if ((!isOnline) || ((Server.connected) && (turn == 1)) || ((Client.connected) && (turn == 2))) {
	...
	public void chessMove(int MX, int MY) throws IOException {
		if (gameStarted) {
			if (selected == -1) {
				if ((isLocated(MX / 50, MY / 50) != -1) && (getPiece(MX / 50, MY / 50).getSide() == turn)) {
					selected = isLocated(MX / 50, MY / 50);
					if (Server.connected)
						server.sendMessage(MX + " " + MY);
					if (Client.connected)
						client.sendMessage(MX + " " + MY);
				}
			} else {
				if (pieces[selected].isValid(MX / 50, MY / 50)) {
					...
					if (pieces[selected].getName().equals("Black Pawn")) {
						if (pieces[selected].getY() == GameMode.getY() - 1) {
							try {
								pieces[selected] = new Queen(pieces[selected].getX(), pieces[selected].getY(), 2,
										"Black Queen");
							} catch (IOException e1) {
								e1.printStackTrace();
							}
						}
					} else if ((pieces[selected].getName().equals("White Pawn")) && (pieces[selected].getY() == 0)) {
						try {
							pieces[selected] = new Queen(pieces[selected].getX(), pieces[selected].getY(), 1,
									"White Queen");
						} catch (IOException e1) {
							e1.printStackTrace();
						}
						...
						if (pieces[selected].isPoison()) {
							for (int pX = pieces[selected].getX() - 1; pX < pieces[selected].getX() + 2; pX++) {
								for (int pY = pieces[selected].getY() - 1; pY < pieces[selected].getY() + 2; pY++) {
									...
									if ((loc != -1) && (pieces[loc].getSide() != pieces[selected].getSide())
											&& (pieces[loc].getHealth() == 0)) {
							...
							if (pieces[ploc] != null) {
								...
								if (pieces[ploc].getHealth() == 10) {
									...
									if ((ploc == 0) || (ploc == 1)) {
										...
										if (server != null)
											server.sendMessage("Checkmate");
										if (Client.connected)
											client.sendMessage("Checkmate");
										turn = 0;
										gameStarted = false;
									}
	...
	private boolean isCheckMate(int side) {
		for (int i = 0; i < pieces.length; i++) {
			if ((pieces[i] != null) && (pieces[i].getSide() == side)) {
	...
	public static void newGame(int mode) throws IOException {
		turn = 1;
		switch (mode) {
		case 1:
		...
		case 4:
			...
			pieces[4] = new Rook(0, 0, 2, "Black Rook");
			pieces[5] = new Rook(7, 0, 2, "Black Rook");
			pieces[6] = new Pawn(1, 7, 1, "white Pawn");
			pieces[7] = new Pawn(6, 7, 1, "White Pawn");
			pieces[8] = new Pawn(0, 7, 1, "White Pawn");
			pieces[9] = new Pawn(7, 7, 1, "White Pawn");
			pieces[10] = new Bishop(2, 0, 2, "Black Bishop");
			pieces[11] = new Bishop(5, 0, 2, "Black Bishop");
			pieces[12] = new Pawn(2, 7, 1, "White Pawn");
			pieces[13] = new Pawn(5, 7, 1, "White Pawn");
			pieces[14] = new Pawn(0, 6, 1, "White Pawn");
			pieces[15] = new Pawn(1, 6, 1, "White Pawn");
			pieces[16] = new Pawn(2, 6, 1, "White Pawn");
			pieces[17] = new Pawn(3, 6, 1, "White Pawn");
			...
			pieces[22] = new Pawn(3, 7, 1, "White Pawn");
			pieces[32] = new Pawn(0, 4, 1, "White Pawn");
			pieces[33] = new Pawn(1, 4, 1, "White Pawn");
			pieces[34] = new Pawn(2, 4, 1, "White Pawn");
			pieces[35] = new Pawn(3, 4, 1, "White Pawn");
			pieces[36] = new Pawn(4, 4, 1, "White Pawn");
			pieces[37] = new Pawn(5, 4, 1, "White Pawn");
			pieces[38] = new Pawn(6, 4, 1, "White Pawn");
			pieces[39] = new Pawn(7, 4, 1, "White Pawn");
			pieces[40] = new Pawn(0, 5, 1, "White Pawn");
			pieces[41] = new Pawn(1, 5, 1, "White Pawn");
			pieces[42] = new Pawn(2, 5, 1, "White Pawn");
			pieces[43] = new Pawn(3, 5, 1, "White Pawn");
			pieces[44] = new Pawn(4, 5, 1, "White Pawn");
			pieces[45] = new Pawn(5, 5, 1, "White Pawn");
			pieces[46] = new Pawn(6, 5, 1, "White Pawn");
			pieces[47] = new Pawn(7, 5, 1, "White Pawn");
			break;
		...
		case 7:
			...
			pieces[8] = new Rook(0, 7, 1, "White Rook");
			pieces[9] = new Rook(7, 7, 1, "White Rook");
			pieces[10] = new Bishop(5, 0, 2, "Black Bishop");
			pieces[11] = new Bishop(2, 0, 2, "Black Bishop");
			pieces[12] = new Bishop(5, 7, 1, "White Bishop");
			pieces[13] = new Bishop(2, 7, 1, "White Bishop");
			pieces[14] = new Pawn(0, 6, 1, "White Pawn");
			pieces[15] = new Pawn(1, 6, 1, "White Pawn");
			pieces[16] = new Pawn(2, 6, 1, "White Pawn");
			...
			pieces[30] = new Pawn(7, 1, 2, "Black Pawn");
			pieces[31] = new Queen(3, 0, 2, "Black Queen");
			pieces[22] = new Pawn(1, 5, 1, "White Pawn");
			pieces[32] = new Pawn(2, 5, 1, "White Pawn");
			pieces[33] = new Pawn(2, 4, 1, "White Pawn");
			pieces[34] = new Pawn(3, 4, 1, "White Pawn");
			pieces[35] = new Pawn(4, 4, 1, "White Pawn");
			pieces[36] = new Pawn(5, 4, 1, "White Pawn");
			pieces[37] = new Pawn(5, 5, 1, "White Pawn");
			pieces[38] = new Pawn(6, 5, 1, "White Pawn");
			break;

		case 8:
			pieces = new ChessPiece[15];
			pieces[0] = new King(4, 0, 2, "Black King");
			pieces[1] = new King(4, 7, 1, "White King");
			pieces[2] = new Knight(5, 0, 2, "Black Knight");
			pieces[3] = new Knight(6, 0, 2, "Black Knight");
			pieces[4] = new Knight(1, 0, 2, "Black Knight");
			pieces[5] = new Knight(2, 0, 2, "Black Knight");

			pieces[6] = new Pawn(0, 6, 1, "White Pawn");
			pieces[7] = new Pawn(1, 6, 1, "White Pawn");
			pieces[8] = new Pawn(2, 6, 1, "White Pawn");
			pieces[9] = new Pawn(3, 6, 1, "White Pawn");
			pieces[10] = new Pawn(4, 6, 1, "White Pawn");
			pieces[11] = new Pawn(5, 6, 1, "White Pawn");
			pieces[12] = new Pawn(6, 6, 1, "White Pawn");
			pieces[13] = new Pawn(7, 6, 1, "White Pawn");
			pieces[14] = new Pawn(4, 1, 2, "Black Pawn");
		...
		case 9:
			...
			pieces[2] = new Knight(1, 0, 2, "Black Knight");
			pieces[3] = new Knight(6, 0, 2, "Black Knight");
			pieces[4] = new Knight(0, 0, 2, "Black Rook");
			pieces[5] = new Knight(7, 0, 2, "Black Rook");
			pieces[6] = new Knight(1, 7, 1, "White Knight");
			pieces[7] = new Knight(6, 7, 1, "White Knight");
			pieces[8] = new Rook(0, 7, 1, "White Rook");
			pieces[9] = new Rook(7, 7, 1, "White Rook");
			pieces[10] = new Knight(2, 0, 2, "Black Knight");
			pieces[11] = new Knight(5, 0, 2, "Black Knight");
			pieces[12] = new Bishop(2, 7, 1, "White Bishop");
			pieces[13] = new Bishop(5, 7, 1, "White Bishop");
			pieces[14] = new Pawn(0, 6, 1, "White Pawn");
			pieces[15] = new Pawn(1, 6, 1, "White Pawn");
			...
			pieces[29] = new Pawn(6, 1, 2, "Black Pawn");
			pieces[30] = new Pawn(7, 1, 2, "Black Pawn");
			pieces[31] = new Knight(3, 0, 2, "Black Knight");
			pieces[22] = new Queen(3, 7, 1, "White Queen");
			pieces[32] = new Pawn(2, 2, 2, "Black Pawn");
			pieces[33] = new Pawn(1, 3, 2, "Black Pawn");
			pieces[34] = new Pawn(2, 3, 2, "Black Pawn");
			pieces[35] = new Pawn(3, 3, 2, "Black Pawn");
			pieces[36] = new Pawn(4, 3, 2, "Black Pawn");
			pieces[37] = new Pawn(5, 3, 2, "Black Pawn");
			pieces[38] = new Pawn(6, 3, 2, "Black Pawn");
			pieces[39] = new Pawn(5, 2, 2, "Black Pawn");
		}
